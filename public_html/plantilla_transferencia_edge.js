                    ...
                    dom: [
                        {
                            ...
                            fill: ["rgba(0,0,0,0)",im+"plantilla/fondo_plantilla.png",'0px','0px']
                        },
                        {
                            id: 'cont_blancopac',
                            type: 'image',
                            rect: ['8px', '50px', '1063px', '442px', 'auto', 'auto'],
                            fill: ["rgba(0,0,0,0)",im+"plantilla/cont_blancopac.png",'0px','0px']
                        },
                        {
                            id: 'home',
                            symbolName: 'home',
                        ...
                        },
                        {
                            ...
                            fill: ["rgba(0,0,0,0)",im+"plantilla/barra_sena.png",'0px','0px']
                        },
                        {
                        ...
                        },
                        {
                            ...
                            cursor: 'pointer',
                            fill: ["rgba(0,0,0,0)",im+"plantilla/btn_menu-desp.png",'0px','0px']
                        },
                        {
                            id: 'contenedor_popup',
                    ...
                    dom: [
                        {
                            ...
                            cursor: 'default',
                            fill: ['rgba(0,0,0,0)', 'images/plantilla/barra_herr-final.png', '0px', '0px']
                        },
                        {
                            type: 'rect',
                            id: 'btn_acces',
